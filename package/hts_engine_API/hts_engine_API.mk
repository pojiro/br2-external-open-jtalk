...
HTS_ENGINE_API_SITE = http://sourceforge.net/projects/hts-engine/files/hts_engine%20API/hts_engine_API-$(HTS_ENGINE_API_VERSION)/hts_engine_API-$(HTS_ENGINE_API_VERSION).tar.gz
